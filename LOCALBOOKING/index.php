...
<body class="bg- light">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark px-lg-3 py-lg-2 shadow-sm sticky-top">
        <div class="container-fluid">
            <a class="navbar-brand me-5 fw-bold fs-3 h-font" href="index.php"> WiseBooking </a>
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item">
                        <a class="nav-link me-3" href="#">Book</a>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <form>
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                        <i class="bi bi-person-lines-fill fs-3 me-2"></i></s>User Registration
                        </h5>
                        <button type="reset" class="btn-close shadow-none" data-bs-dismiss="modal" aria-label="Close"></button>
                        </div>
                        <div class="modal-body">
                        <span class="badge rounded-pill bg-light text-dark mb-3 text-wrap lh-base">
                            Note: Please ensure all required fields are completed.
                        </span>
                        <div class="container-fluid">
                            <div class="row">
            ...
            <div class="swiper-wrapper mb-5">
                <div class="swiper-slide bg-white p-4">
                    <div class="profile d-flex align-items-center mb-3">
                        <img src="images/features/ac.svg" width="30px">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4">
                    <h5>Call us</h5>
                    <a href="tel: 955 0222 321" class="d-inline-block mb-2 text-decoration-none text-dark" >
                        <i class="bi bi-telephone-fill"></i>+955 0222 321
                    </a>
                    <br>
                    <a href="tel: 955 0222 321" class="d-inline-block text-decoration-none text-dark" >
                        <i class="bi bi-telephone-fill"></i>+955 0222 321
                    </a>
                </div>
                <div class="bg-white p-4 rounded mb-4">
    ...
    <div class="container-fluid bg-white mt-5">
        <div class="row">
            <div class="col-lg-4 p-4">
                <h3 class="h-font fw-bold fs-3">WiseBooking</h3>
                <p>
            ...
            <div class="col-lg-4 p-4">
                ...
                <a href="#" class="d-inline-block mb-2 text-dark text-decoration-none">Book</a> <br>
    ...
    <h6 class="text-center bg-dark text-white p-3 m-0">Designed and Develop by THE IDIOTS</h6>
